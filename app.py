...
def backup():
    ...
    # Funcționalitatea de backup este temporar dezactivată pentru stabilitate
    return render_template('backup.html', 
                         backups=[], 
                         gdrive_info={'error': 'Funcționalitatea de backup este temporar dezactivată pentru stabilitate.'})
